...
const CreateCharacter = () => {
  ...
  const getPreviewAvatar = () => {
    if (avatarType === "upload" && avatar) {
      return <img src={avatar} alt="Character preview" className="h-16 w-16 rounded-full object-cover shadow-soft" />;
    }
    return <div className="h-16 w-16 rounded-full flex items-center justify-center shadow-soft" style={{
                  ...
                  {avatarType === "upload" && <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-4">
                        {avatar ? <div className="relative">
                            <img src={avatar} alt="Character avatar" className="h-16 w-16 rounded-full object-cover shadow-soft" />
                            <Button type="button" variant="destructive" size="icon" className="absolute -top-2 -right-2 h-6 w-6" onClick={() => setAvatar("")}>
                              <X className="h-3 w-3" />
                            </Button>
                          </div> : <div className="h-16 w-16 rounded-full bg-muted flex items-center justify-center">
