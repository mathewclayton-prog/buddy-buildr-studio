...
export const CatbotCard = ({ catbot, variant = 'chat', delay = 0 }: CatbotCardProps) => {
  ...
  return (
    <CardWrapper>
      <Card 
        className="group cursor-pointer overflow-hidden shadow-card hover:shadow-primary transition-all duration-300 hover-lift-subtle animate-fade-in bg-card border border-orange-500 flex flex-col h-full"
