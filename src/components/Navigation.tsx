  ...
  return <header className="border-b bg-white backdrop-blur-sm sticky top-0 z-50 text-black">
      <div className="container mx-auto px-4 py-2 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 hover:opacity-70 transition-opacity text-black">
          ...
          <span className="text-muted-foreground text-sm font-normal">beta</span>
        </Link>
        ...
        <nav className="flex items-center gap-4">
          ...
          {user ? <>
              ...
              <Link to="/create" className="px-3 py-2 rounded-md text-sm font-medium text-white bg-primary hover:bg-primary/90 transition-colors flex items-center gap-2">
              ...
              <Link to="/auth" className="px-3 py-2 rounded-md text-sm font-medium text-white bg-primary hover:bg-primary/90 transition-colors flex items-center gap-2">
                <User className="h-4 w-4" />
